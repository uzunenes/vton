...
export const PIPELINE_STEPS: StepDefinition[] = [
  {
    ...
    description: "Segment garment from background using Meta SAM3",
  ...
  },
  {
    id: "virtual-tryon",
    name: "Virtual Try-On",
    description: "Generate try-on using FASHN v1.6 + Leffa (A/B)",
    requiresApproval: true,
    canRetry: true,
    maxRetries: 2,
  ...
  },
  {
    ...
    description: "Generate runway video using Kling 3.0 Pro",
    requiresApproval: true,
    canRetry: true,
    maxRetries: 1,
