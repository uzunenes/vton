...
export const SEGMENTATION_MODELS: Record<string, SegmentationModelConfig> = {
  "sam3-image": {
    ...
    displayName: "SAM3 Image (2025)",
    description:
      "Meta SAM3 with 2x better accuracy, text prompts, and 40% faster processing",
    costPerRun: 0.005,
    averageTimeSeconds: 0.05,
    category: "segmentation",
...
export function getSegmentationModel(
  id: string,
): SegmentationModelConfig | undefined {
